...
describe('scientificNumber', () => {
  it('number with 4 rounded decimals', () => {
  ...
  it('no number values return -', () => {
    const value = 'foo';
    expect(scientificNumber(value, 2)).toEqual('-')
  })
  ...
  it('negative integer display negative sign', () => {
    const value = -1000;
    expect(scientificNumber(value, 2)).toEqual('-1,000')
  })

  describe('exponent value', () => {
    it('exponent value 3 is replaced by k', () => {
      const value = 10550;
      expect(scientificNumber(value, 2)).toEqual('10.55k')
    })
